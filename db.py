...
def db_init():
    ...
    r_competitions = [('England - Premier League', 'Europe', 'en', f'{IMG_COMPETITIONS_PATH}England - Premier League.png'),
                ...
                ('USA/Canada - Major League Soccer', 'North America', 'en', f'{IMG_COMPETITIONS_PATH}USA/Canada - Major League Soccer.png'),
                ...
                ('EE. UU./Canadá - Major League Soccer', 'North America', 'es', f'{IMG_COMPETITIONS_PATH}USA/Canada - Major League Soccer.png'),
